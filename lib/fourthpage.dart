...
backgroundColor: Color.fromARGB(255, 0, 79, 82),
   body: SingleChildScrollView(
     ...
     Padding(
       ...
       child: Center(child: Text("What would you like to improve at the moment?",style: TextStyle(color: Colors.white,fontSize: 25,letterSpacing: 2,fontWeight: FontWeight.w400),textAlign: TextAlign.center,)),
     ),
     Row(
       children: [
         Padding(
           padding: const EdgeInsets.fromLTRB(30, 50, 13, 0),
    ...
    Row(
       children: [
         Padding(
           padding: const EdgeInsets.fromLTRB(30, 10, 13, 0),
           child: ElevatedButton(
