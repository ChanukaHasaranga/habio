...
import 'package:habio/eightpage.dart';
import 'package:habio/eleventhpage.dart';
   ...
   body: SafeArea(
     child: SingleChildScrollView(
       ...
       Padding(
         ...
         child: Center(child: Text("How much time are you ready to devote to working on your habits?",style: TextStyle(color: Colors.white,fontSize: 25,letterSpacing: 2,fontWeight: FontWeight.w400,),textAlign:TextAlign.center,)),
       ),
       Padding(
         ...
         child: ElevatedButton(
          ...
          crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              ...
              Text("Ready to work every day",style: TextStyle(color: Colors.black,fontSize: 17),),
            ],          
         ...
         child: ElevatedButton(
          ...
          crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              ...
              Text("A couple of hours a week",style: TextStyle(color: Colors.black,fontSize: 17),)
            ],          
         ...
         child: ElevatedButton(
          ...
          crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              ...
              Text("I have very little time to spare",style: TextStyle(color: Colors.black,fontSize: 17),),
            ],          
