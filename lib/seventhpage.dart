...
backgroundColor: Color.fromARGB(255, 0, 79, 82),
   body: SingleChildScrollView(
     ...
     Padding(
       ...
       child: Center(child: Text("How often do you have trouble falling asleep?",style: TextStyle(color: Colors.white,fontSize: 25,letterSpacing: 2,fontWeight: FontWeight.w400,),textAlign:TextAlign.center,)),
     ),
     Padding(
       ...
       child: ElevatedButton(
        ...
        crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            ...
            Text("I have no sleep problems",style: TextStyle(color: Colors.black,fontSize: 17),),
          ],          
       ...
       child: ElevatedButton(
        ...
        crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            ...
            Text("Not often",style: TextStyle(color: Colors.black,fontSize: 17),)
          ],          
       ...
       child: ElevatedButton(
        ...
        crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            ...
            Text("Frequently",style: TextStyle(color: Colors.black,fontSize: 17),),
          ],          
