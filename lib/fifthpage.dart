         ...
         child: ElevatedButton(
          ...
          crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              ...
              Text("Very active",style: TextStyle(color: Colors.black,fontSize: 17),),
            ],          
         ...
         child: ElevatedButton(
          ...
          crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              ...
              Text("Moderately active",style: TextStyle(color: Colors.black,fontSize: 17),)
            ],          
         ...
         child: ElevatedButton(
          ...
          crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              ...
              Text("Sedentary",style: TextStyle(color: Colors.black,fontSize: 17),),
            ],          
