   ...
   body: SafeArea(
     child: SingleChildScrollView(
       ...
       Padding(
         ...
         child: Center(child: Text("How do you usually feel about change?",style: TextStyle(color: Colors.white,fontSize: 25,letterSpacing: 2,fontWeight: FontWeight.w400,),textAlign:TextAlign.center,)),
       ),
       Padding(
         ...
         child: ElevatedButton(
          ...
          crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              ...
              Text("I adapt quickly and easily",style: TextStyle(color: Colors.black,fontSize: 17),),
            ],          
         ...
         child: ElevatedButton(
          ...
          crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              ...
              Text("I need time to get used",style: TextStyle(color: Colors.black,fontSize: 17),)
            ],          
         ...
         child: ElevatedButton(
          ...
          crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              ...
              Text("Change scares me",style: TextStyle(color: Colors.black,fontSize: 17),),
            ],          
